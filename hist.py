...
x = ['40대', '50대', '60대', '70대 이상']

# plt.bar([i * 2 for i in range(len(x))], menSaltRate, color="lightblue", label="남성", alpha=0.5)
# plt.bar([i * 2 + 0.5 for i in range(len(x))], womenSaltRate, color="lightpink", label="여성", alpha=0.5)
# plt.xlabel('연령')
# plt.ylabel('나트륨 섭취량')
# plt.legend()
# plt.title('남녀 나트륨 섭취량')


# plt.show()

# sns.barplot(data=menSaltRate, x='x', color="lightblue", label="남성", alpha=0.5, kde=True, log_scale=False)
# sns.barplot(data=womenSaltRate, x='x', color="lightpink", label="여성", alpha=0.5, kde=True, log_scale=False)
#
# plt.show()

# sns.histplot(data=stomach_cancer[condiM], x='AGE', color="lightblue", label="남성", alpha=0.5, kde=True, log_scale=False)
# sns.histplot(data=stomach_cancer[condiW], x='AGE', color="lightpink", label="여성", alpha=0.5, kde=True, log_scale=False)